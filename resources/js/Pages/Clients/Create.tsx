...
import { UserPlus, ArrowLeft, Save, Building, FileText, MapPin, Phone, CheckCircle, User } from 'lucide-react';
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                    <div className="bg-gradient-to-r from-indigo-800 to-indigo-900 px-8 py-6 flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div>
                                <h3 className="text-white font-bold text-xl">Agregar Nuevo Cliente</h3>
                                <p className="text-indigo-200 text-sm">Ingrese los detalles del cliente para registrarlo en el sistema</p>
                            </div>
                        </div>
                    </div>
