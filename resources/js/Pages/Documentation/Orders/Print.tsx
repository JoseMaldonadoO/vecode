        ...
        <div className="bg-white min-h-screen">
            ...
            <div className="max-w-[215mm] mx-auto bg-white p-2">
                ...
                <table className="mb-2">
                    <tr>
                        <th className="text-center text-lg no-border font-bold">POLÍTICA PARA EL PROCESO DE EMBARQUES</th>
                    </tr>
                    <tr>
                        <td className="no-border p-0">
                            <table className="w-full">
                                <tr>
                                    <td className="w-3/4 border-0 border-b border-r bg-white font-bold pl-2 text-[10px]">
                                        <div>PROAGROINDUSTRIA, S.A. DE C.V.</div>
                                        <div className="font-normal">Carretera Coatzacoalcos-Villahermosa km 5, Centro.</div>
                    ...
                    <tr>
                        <th className="text-center font-bold border bg-white text-xs py-0.5">GLS-TR-FO-013</th>
                    </tr>
                </table>

                {/* POLICY DETAILS */}
                <table className="mb-1 text-[8px]">
                    <tr className="h-4">
                        <td className="font-bold border pl-2 w-1/3">NOMBRE DEL DEPARTAMENTO</td>
                        <td className="border text-center font-bold w-1/3">LOGÍSTICA Y SUMINISTRO</td>
                        <td className="font-bold border w-1/6 pl-2">POLÍTICA N°</td>
                        <td className="border text-center font-bold w-1/6">1</td>
                    </tr>
                    <tr className="h-4">
                        <td className="font-bold border pl-2">FECHA DE ENTRADA EN VIGOR:</td>
                        <td className="border text-center">13 DE JUNIO DEL 2023</td>
                        <td className="font-bold border pl-2">VERSIÓN N°</td>
                        <td className="border text-center">1</td>
                    </tr>
                    <tr><td colSpan={4} className="text-center font-bold text-blue-800 tracking-widest text-[9px] py-0.5 no-border">ALCANCE</td></tr>
                    <tr><td colSpan={4} className="p-1 text-justify border text-gray-600">La Presente política es aplicable a los diferentes grupos de interés que forman parte del proceso de los embarques de producto terminado dentro de las instalaciones del Proagroindustria, S.A. de C.V., con especial énfasis en el operador de las líneas transportistas que ingresan a las instalaciones.</td></tr>
                    <tr><td colSpan={4} className="text-center font-bold text-blue-800 tracking-widest text-[9px] py-0.5 no-border">DECLARACIÓN DE LA POLÍTICA</td></tr>
                    <tr><td colSpan={4} className="p-1 text-justify border text-gray-600">La presente política se realiza como medida para salvaguardar y cumplir con las buenas prácticas de comportamiento, seguridad del personal, protección a instalaciones e infraestructura.</td></tr>
                </table>

                <div className="text-center font-bold border-none text-blue-800 text-[10px] mb-1 tracking-widest">SECCIÓN DE LAS POLÍTICAS</div>
                <table className="text-[7px]">
                    <tr>
                        <th className="w-1/2 text-center font-bold py-1 no-border">ASPECTOS GENERALES</th>
                        <th className="w-1/2 text-center font-bold py-1 no-border">POLÍTICA DEL ÁREA DE ALMACENES DE PRODUCTO TERMINADO</th>
                    </tr>
                    <tr>
                        <td className="align-top p-0.5 border-none">1. Portar correctamente el equipo de protección personal.</td>
                        <td className="align-top p-0.5 border-none" rowSpan={2}>10. Para el caso de las unidades tipo plataforma es requisito indispensable salir del almacén con <b>por lo menos el 50% de las estibas amarradas</b>, y con la carga tapada.</td>
                    </tr>
                    <tr>
                        <td className="align-top p-0.5 border-none">2. No ingresar bebidas alcohólicas o bajo la influencia de estas mismas.</td>
                    </tr>
                    <tr>
                        <td className="align-top p-0.5 border-none">3. La velocidad permitida en las instalaciones es de <b>20km/h.</b></td>
                        <td className="align-top p-0.5 border-none">11. Las unidades deberán estar en condiciones adecuadas para la carga.</td>
                    </tr>
                    <tr>
                        <td className="align-top p-0.5 border-none">4. La velocidad máxima permitida en los patios de maniobras, y dentro de los almacenes de es <b>10 km/h.</b></td>
                        <td className="align-top p-0.5 border-none">12. Los supervisores de carga no son responsables por la pérdida del turno de carga.</td>
                    </tr>
                    <tr>
                        <td className="align-top p-0.5 border-none">5. Para el caso de las unidades tipo “caja seca” el operador deberá corroborar cuando finalice su carga que este correctamente cerrada, para que el operador de bascula proceda a colocar el o los sellos correspondientes.</td>
                        <td className="align-top p-0.5 border-none">13. Por razones de preservación del producto, queda estrictamente prohibido mantener funcionando el aire acondicionado de la unidad durante su estancia en los almacenes.</td>
                    </tr>
                    <tr>
                        <td className="align-top p-0.5 border-none">6. Para el caso de las unidades tipo “Jaula” el operador deberá corroborar que todas las escotillas se encuentren correctamente cerradas, y las lonas se encuentren en optimas condiciones para su uso.</td>
                        <td className="align-top p-0.5 border-none">14. Es responsabilidad del operador estar pendiente durante el proceso de carga. El operador debe comunicar al supervisor en turno cualquier observación referente a su carga, cualquier observación de inconformidad con la carga que se manifieste.</td>
                    </tr>
                    <tr>
                        <td className="align-top p-0.5 border-none">7. Finalizado el proceso de carga, es responsabilidad del operador el aseguramiento de la carga. (amarre, enlonada, etc.)</td>
                        <td className="align-top p-0.5 border-none">15. Queda estrictamente prohibido que operadores graben videos o tomen fotografías de las instalaciones o del proceso de operación de carga.</td>
                    </tr>
                    <tr>
                        <td className="align-top p-0.5 border-none">8. El retiro de lona de la unidad, o enlonada de las unidades son responsabilidad únicamente del operador de la unidad y/o línea transportista.</td>
                        <td className="align-top p-0.5 border-none">16. Finalizado el proceso de carga la unidad deberá permanecer en el patio de maniobras debidamente estacionada hasta que le sea indicado su salida.</td>
                    </tr>
                    <tr>
                        <td className="align-top p-0.5 border-none">9. Queda estrictamente prohibido el acceso a las instalaciones a cualquier persona (polizon) ajena a la carga, dentro de las unidades.</td>
                        <td className="text-center align-middle font-bold h-12 border-none">
                            OPERADOR DE UNIDAD<br />
