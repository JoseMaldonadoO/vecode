                                ...
                                <div className="bg-blue-50 p-6 rounded-xl border border-blue-100 mb-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="md:col-span-2 pt-4 border-t border-blue-100">
                                        <div className="flex items-center justify-between mb-4">
                                            <InputLabel value="Distribución por Bodegas" className="text-blue-800 font-bold flex items-center">
                                                ...
                                                {data.holds.map((hold, idx) => (
                                                    <div key={idx} className="bg-white p-2 rounded-xl border border-blue-200 shadow-sm transition-all hover:border-blue-400">
                                                        ...
                                                        <TextInput
                                                            ...
                                                            className="w-full text-sm py-1 px-2 border-none focus:ring-0 bg-blue-50/50 rounded-lg font-bold text-blue-900 h-8"
                                                            placeholder="0.00"
                                                        />
                                                    </div>
                                                ))}
                                    ...
                                    <div className="pt-4 border-t border-orange-100">
                                        <div className="flex items-center justify-between mb-4">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-orange-800 font-bold">Distribución por Bodegas</span>
                                            </div>
                                                ...
                                                {data.holds.map((hold, idx) => (
                                                    <div key={idx} className="bg-white p-2 rounded-xl border border-orange-200 shadow-sm transition-all hover:border-orange-400 text-center">
                                                        ...
                                                        <TextInput
                                                            ...
                                                            value={hold.tonnage}
                                                            onChange={(e) => handleHoldTonnageChange(idx, e.target.value)}
                                                            className="w-full text-sm py-1 px-2 border-none focus:ring-0 bg-orange-50/50 rounded-lg font-bold text-orange-900 h-8"
                                                            placeholder="0.00"
                                                        />
                                                    </div>
                                                ))}
