...
export default function Edit({ auth, role, permissions }: { auth: any, role: any, permissions: any[] }) {
        ...
        <DashboardLayout user={auth.user} header={`Editar Rol: ${role.name}`}>
            ...
            <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-4">Permisos</label>
                    ...
                    <div className="flex items-center justify-end">
                        <Link href={route('admin.roles.index')} className="text-sm text-gray-600 hover:text-gray-900 mr-4">
                            Cancelar
                        </Link>
                        <button
                            type="submit"
