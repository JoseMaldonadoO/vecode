...
export default function EntrySale({ auth, active_scale_id = 1 }: { auth: any, active_scale_id?: number }) {
    ...
    return (
        <DashboardLayout user={auth.user} header="Báscula - Salida / Carga (Peso Tara)">
