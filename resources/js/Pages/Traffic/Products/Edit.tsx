...
export default function Edit({ auth, product }: { auth: any, product: Product }) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('traffic.products.update', product.id));
    };

    return (
        <DashboardLayout user={auth.user} header={`Editar Producto: ${product.name}`}>
            ...
            <div className="py-8 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    <div className="bg-gradient-to-r from-indigo-800 to-indigo-900 px-8 py-6">
                        ...
                        <p className="text-indigo-200 text-sm mt-1">Modifica la información del producto #{product.id}.</p>
                    </div>
