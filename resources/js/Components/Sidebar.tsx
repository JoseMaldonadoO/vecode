...
export function Sidebar({ className }: SidebarProps) {
    ...
    return (
        <div className={cn("pb-12 min-h-screen border-r border-slate-800 bg-gradient-to-b from-slate-900 via-slate-900 to-black text-white shadow-2xl overflow-y-auto scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent h-screen fixed w-64 z-50", className)}>
